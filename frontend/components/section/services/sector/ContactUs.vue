...
export type ISectionContactUs = {
  title: string
  description: string
  formData: ContactUsWithout
}

const props = defineProps<ISectionContactUs>();
const config = useRuntimeConfig();
</script>

<style scoped>
.contact__section {
  @apply mt-[160px] md:mt-[118px] sm:mt-[95px]
}

.contact__content {
  @apply flex items-start justify-between w-full mt-[58px]
  xl:mt-[65px]
  lg:flex-col md:mt-[63px] sm:mt-[36px]
}
