...
.description__block {
  ...
  xl:max-w-[995px] xl:mr-[71px] xl:mt-[0]
...
.about-us__description {
  @apply flex flex-col items-start justify-center gap-[14px] mt-[32px] pl-[124px] opacity-0
  xl:gap-[20px]
  lg:pl-0
  md:justify-start md:items-start md:gap-[14px] md:mt-[25px]
  sm:mt-[24px]
}

.about-us__description-text {
  @apply max-w-[470px] mr-[217px] font-light text-[18px] text-black leading-[105%] font-onest tracking-[-0.72px]
  xl:max-w-[440px] xl:mr-[26px] xl:leading-[116%]
  md:max-w-[501px] md:mr-0 md:leading-[107%] md:tracking-[-0.68px]
  sm:text-[16px] sm:leading-[16.9px] sm:tracking-[-0.64px]
}
</style>