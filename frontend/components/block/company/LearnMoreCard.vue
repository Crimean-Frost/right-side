...
<style scoped>
.learn-more__cards {
  @apply grid grid-cols-2 gap-[10px] md:grid-cols-1 sm:mx-[-6px]
}

.learn-more__card {
  @apply relative p-[30px] h-[415.5px] w-full bg-[#23303866] rounded-[15px]
  xl:h-[300px] xl:py-[24px] xl:px-[27px]
  md:p-[25px]
  sm:h-[291px] sm:py-[25px]
}

.learn-more__card-title {
  @apply text-[26px] text-white leading-[31.2px] font-golos font-medium sm:text-[18px] sm:leading-[21.6px]
}
...
.learn-more__button {
  ...
  md:bottom-[27px] md:right-[25px] md:w-[200px] md:h-[48px]
  sm:bottom-[25px] sm:right-[25px] sm:w-[calc(100%-50px)] sm:h-[50px]
}
</style>