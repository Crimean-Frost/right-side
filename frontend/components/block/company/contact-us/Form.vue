<template>
  <div class="form__container">
    <form class="form__inner" @submit.prevent="handleSubmit">
      ...
      <ButtonContactUs class="form__drop-down-button" :text="contactUsForm.button"/>
    </form>
  </div>
</template>
...
export type SectionCompanyContactUsFormProps = {
  contactUsForm: ContactUsForm
}

const props = defineProps<SectionCompanyContactUsFormProps>();
...
.form__drop-down-container {
  @apply grid grid-cols-2 gap-[18px] mb-[20px] xl:gap-[10px] xl:mb-[14px] lg:mb-[12px] sm:grid-cols-1 sm:gap-[12px] sm:mb-[20px]
}
...
.form__drop-down-button {
  @apply mt-[38px] mx-auto xl:mt-[40px] md:mt-[62px] sm:mt-[50px]
}
</style>