<template>
  <article class="article" v-for="(articleItem, index) in blogArticleListData" :key="index">
    <picture>
    ...
    <ButtonSecondary :to="`${route.path}` + articleItem.slug" class="article__button">
      {{ generalCardButton }}
    </ButtonSecondary>
  </article>
</template>
...
.article {
  ...
  md:h-[428px] md:py-[23.5px] md:px-[13.5px] md:rounded-[15px]
...
.article__title {
  @apply mb-[12.5px] font-golos text-black text-[26px] leading-[31.2px] font-medium
  xl:mb-[11px] xl:text-[22px] xl:leading-[26.4px]
  md:mb-[13.5px] sm:text-[16px] sm:leading-[19.2px] sm:mb-[13px]
}

.article__button {
  @apply absolute bottom-[22.5px] left-[21.5px] w-[200px] h-[50px] inline-flex items-center justify-center text-black
  font-onest font-light tracking-[-0.6px] border border-orange rounded-[30px] pt-[1px]
  xl:bottom-[25px] xl:left-[24px]
  md:bottom-[22.5px] md:left-[11.5px]
