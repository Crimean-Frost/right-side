...
export type BlockCasesLearnMoreCardProps = {
  cards?: TitleCard[],
}
const props = defineProps<BlockCasesLearnMoreCardProps>();
</script>
...
.learn-more__card {
  @apply relative p-[30px] h-[417.5px] w-full bg-[#23303866] rounded-[15px]
...
.learn-more__card-title {
  @apply text-[26px] text-white font-golos leading-[31.2px] font-medium
  xl:ml-[2px]
  md:ml-0
...
.learn-more__button {
  @apply absolute bottom-[32px] right-[32px] w-[250px] border font-light
  xl:w-[200px] xl:h-[50px] xl:bottom-[25px] xl:right-[23px]
  md:bottom-[25px] md:right-[25px]
  sm:w-[calc(100%-50px)] sm:h-[50px] sm:bottom-[25px] sm:right-[25px] sm:tracking-[0.5px]
}
</style>