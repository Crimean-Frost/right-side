...
import Form from "~/components/block/contact-us/Form.vue";
import type {PageFormErrors} from "~/components/block/services-page/contact-us/Form.vue";

export type SectionCaseContactUsFormProps = {
  contactUsForm: ContactUsForm
}

const props = defineProps<SectionCaseContactUsFormProps>();
...
.form__drop-down-button {
  @apply mt-[40px] mx-auto xl:mt-[38px] md:mt-[61px] sm:mt-[31px]
}
</style>