...
.carousel__item {
  ...
  sm:w-[336px] sm:min-w-[336px] sm:h-[245px] sm:py-[48px] sm:pb-[57px] sm:px-[32.5px]
}
...
.carousel__title {
  ...
  sm:max-w-[90%] sm:max-h-[66px] sm:text-[18px] sm:tracking-[0.3px]
}

.carousel__container-button {
  @apply xl:w-[200px] xl:h-[60px] md:h-[50px]
}
