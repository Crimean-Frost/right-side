<template>
  <div class="form__container">
    <form class="form__inner" @submit.prevent="handleSubmit">
      ...
      <ButtonPrimary class="form__drop-down-button" :text="contactUsForm.button"/>
    </form>
  </div>
</template>
...
export type SectionEmployeeContactUsFormProps = {
  contactUsForm: ContactUsForm
}

const props = defineProps<SectionEmployeeContactUsFormProps>();
...
.form__drop-down-button {
  @apply mt-[38px] mx-auto md:mt-[59px] sm:mt-[29px]
}
</style>