...
.title-block__container-title {
  @apply mt-[-3px] max-w-[223px] min-w-[223px] xl:mt-0 lg:mb-[62px] sm:mb-[45px]
}

.title-block__container-description {
  @apply max-w-[1408px] font-golos mt-[2px] mr-[8px] opacity-0
  ...
  sm:w-full sm:indent-0 sm:pr-[5px] sm:tracking-[-1.3px]
}
</style>