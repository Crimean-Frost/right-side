...
export type PageFormErrors = {
  isName: boolean
  isPhone: boolean
  isAgreement: boolean
}

export type BlockServicesPageContactUsFormProps = {
  contactUsForm: ContactUsForm
}

const props = defineProps<BlockServicesPageContactUsFormProps>();
...
.form__drop-down-button {
  @apply mt-[40px] mx-auto xl:mt-[38px] md:mt-[61px] sm:mt-[30.5px]
}
</style>